    ...
    <div class="container">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="{{ route('add-user.admin') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="fist_name" class="form-control" id="fist_name"
                            placeholder="Nhập Fistname">
                        @error('fist_name')
                            <p style="color:red">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="province_id" id="province" class="form-control select2" style="width: 100%;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="d-none" id="old-district" value="{{old("district")}}">
                                <select name="district_id" id="district" class="form-control select2" style="width: 100%;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input class="d-none" id="old-commune" value="{{old("commune")}}">
                                <select name="commune_id" id="commune" class="form-control select2" style="width: 100%;">
